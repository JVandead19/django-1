...
from .models import PrimerLapso,SegundoLapso,TercerLapso,EAoEsc,Estudiante,AuthUser,Materias_año,Contenido_materia,docent,User
...
@login_required(login_url='/login_docent')           
def aula(request):
